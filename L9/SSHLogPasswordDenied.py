...
if __name__ == "__main__":
    message0: str = "Dec 20 06:55:48 LabSZ sshd[24100]: " \
    ...
    message1: str = "Dec 10 06:55:48 LabSZ sshd[24100]: Failed password for invalid user webmaster from 173.234.31.186 port 38926 ssh2"
