from PySide6.QtWidgets import QStackedWidget, QPushButton, QLineEdit, QLabel, QVBoxLayout, QHBoxLayout
    ...
    def _handle_msg_type(self, type: TypeOfMessage):
        match type:
            case type.ERROR:
                ...
                audio.setVolume(ERROR_MUSIC_VOLUME)
